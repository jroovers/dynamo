...
public final class ResponsiveUtil {
    ...
    public static void addFullWidthComponent(ResponsiveRow row, Component component) {
        ...
        row.addColumn().withDisplayRules(DynamoConstants.MAX_COLUMNS, DynamoConstants.MAX_COLUMNS, DynamoConstants.MAX_COLUMNS,
                DynamoConstants.MAX_COLUMNS).withComponent(component);
    }
    ...
    public static void addFullWidthRow(ResponsiveLayout layout, Component component) {
        layout.addRow().withDefaultRules(DynamoConstants.MAX_COLUMNS, DynamoConstants.MAX_COLUMNS, DynamoConstants.MAX_COLUMNS,
