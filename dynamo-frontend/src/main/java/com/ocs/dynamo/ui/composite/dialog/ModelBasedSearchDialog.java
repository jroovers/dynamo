...
public class ModelBasedSearchDialog<ID extends Serializable, T extends AbstractEntity<ID>> extends SimpleModalDialog {
    ...
    protected void doBuild(ResponsiveLayout parent) {
        ...
        ResponsiveLayout wrapper = new ResponsiveLayout().withFullSize();
        ...
        ResponsiveUtil.addFullWidthRow(wrapper, searchLayout);
        ResponsiveUtil.addFullWidthRow(parent, wrapper);
    }
