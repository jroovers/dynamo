...
public class EditableGridLayoutTest extends BaseIntegrationTest {
    ...
    public void testCreateSimulatenous() {
        ...
        Assert.assertNull(layout.getEditButton());
        Assert.assertNull(layout.getCancelButton());
        Assert.assertNull(layout.getAddButton());
    ...
    public void testCreate() {
        ...
        Assert.assertNull(layout.getSaveButton());
